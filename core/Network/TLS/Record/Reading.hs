...
contentSizeExceeded = Error_Protocol ("record content exceeding maximum size", AlertLevel_Fatal, RecordOverflow)
...
maximumSizeExceeded = Error_Protocol ("record exceeding maximum size", AlertLevel_Fatal, RecordOverflow)
